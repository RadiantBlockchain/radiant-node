...
![Positioning of various blockchains.](w1.jpeg)
...
![OP_PUSHINPUTREF: Transaction References Minting TX](a3.jpeg)
<center>Diagram 3. Minting transaction OP_PUSHINPUTREF reference must match outpoint.</center>
<br/>

![OP_PUSHINPUTREF: Transfer transaction OP_PUSHINPUTREF reference must match one of the previous outputs scripts being spent.](a4.jpeg)
...
![OP_PUSHINPUTREF: Invalid TX with no matching previous output script or outpoint](a5.jpeg)
...
![OP_DISALLOWPUSHINPUTREF: Disallow usage of a specific reference](a7.jpeg)
...
![OP_DISALLOWPUSHINPUTREFSIBLING: Disallow usage of a specific reference in all other outputs than the one in which this instruction appears](a8.jpeg)
...
![OP_UTXODATASUMMARY: OP_UTXODATASUMMARY: Output coloring diagram](a9.jpeg)
<center>Diagram 9. OP_UTXODATASUMMARY: Output coloring diagram </center>
<br/>

![OP_UTXODATASUMMARY: Push to stack the summary of an input being spent.](a10.jpeg)
...
![OP_UTXOREFVALUESUM: Push to stack the total sum of the inputs which match a specific reference hash](a11.jpeg)
...
![Diagram 12. Verify the parent and grand parent to identify forgery.](a12.jpeg)
...
![Diagram 13. Transaction Contents with Embedded Parents](a13.jpeg)
...
![Transaction Id v3 Preimage Embedded](a15.jpeg)
...
![Non-Fungible Token Design Overview](a17.jpeg)
<center>Diagram 17. Non-Fungible Token Design Overview.</center>

<br/>

![Check back parent](a18.jpeg)
...
> <b>Network Abbreviation:</b> RAD<br/>
...
> <b>Block Reward Schedule:</b> 50,000 RAD per block<br/>
> <b>Block Reward Halvening:</b> 2 years<br/>
> <b>Maximum Supply:</b> 21,000,000,000 RAD<br/>
