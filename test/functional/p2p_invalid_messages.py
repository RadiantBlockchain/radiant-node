...
class InvalidMessagesTest(BitcoinTestFramework):
    ...
    def test_oversized_inv_msg(self):
        self.test_oversized_msg(msg_inv([CInv(MSG_TX, 1)] * 50001), 50001, 'oversized-inv')

    def test_oversized_getdata_msg(self):
        self.test_oversized_msg(msg_getdata([CInv(MSG_TX, 1)] * 50001), 50001, 'too-many-inv')

    def test_oversized_headers_msg(self):
        self.test_oversized_msg(msg_headers([CBlockHeader()] * 2001), 2001, 'too-many-headers')
